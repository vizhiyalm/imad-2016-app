    	...
    	<div class="left">
    	    <div class="innerleft">
        		...
        		<div class="link">
        				...
        				<a href="https://github.com/vizhiyalm/imad-2016-app" target="_blank" class="git"><img src="../images/gith.png"></a>
        		</div>
    		</div>
    	</div>
...
app.post('/login', function (req, res) {
   ...
   pool.query('SELECT * FROM "user" WHERE username = $4', [username], function (err, result) {
      if (err) {
          res.status(500).send(err.toString());
      } else {
